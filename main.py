...
from agents1.JustinStrongAgent import JustinStrongAgent
from agents1.JustinColourblindAgent import JustinColourblindAgent
...
if __name__ == "__main__":
    agents = [
        ...
        {'name':'JustinStrong', 'botclass':JustinStrongAgent, 'settings':{}},
        {'name':'JustinColourBlind', 'botclass':JustinColourblindAgent, 'settings':{}},
